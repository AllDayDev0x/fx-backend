...
class VideoCallRequestSentJob implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        try {
            ...
            $message = tr('video_call_request_sent_message');

            $message = str_replace("<%user%>",$video_call_request->user->name ?? '' ,$message);
            ...
            $user = User::where('id', $video_call_request->model_id)->first();
