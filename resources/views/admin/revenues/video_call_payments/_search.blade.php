<form method="GET" action="{{route('admin.video_call_payments.index')}}">
        ...
        <div class="col-xs-12 col-sm-12 col-lg-6 col-md-12">
            ...
            <div class="input-group">
                ...
                <span class="input-group-btn">
                    ...
                    <a href="{{route('admin.video_call_payments.index',['user_id'=>Request::get('user_id')??''])}}" class="btn btn-default reset-btn">
