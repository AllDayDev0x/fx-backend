...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="{{route('admin.product_sub_categories.index')}}">{{tr('product_sub_categories')}}</a>
    </li>
            ...
            <div class="col-xl-12 col-lg-12">
                ...
                <div class="card user-profile-view-sec">
                     ...
                     <div class="card-header border-bottom border-gray">
                        ...
                        <h4 class="card-title">{{tr('view_product_sub_categories')}}</h4>
