<form method="GET" action="{{route('admin.live_videos.payments')}}" class="form-bottom">
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-lg-6 col-md-12">
            ...
            <div class="input-group">
                ...
                <a  href="{{route('admin.live_videos.payments')}}" class="btn btn-default reset-btn"><i class="fa fa-eraser" aria-hidden="true"></i>
                </a>
