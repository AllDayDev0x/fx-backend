                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content px-1 pt-1">
                            ...
                            <div role="tabpanel" class="tab-pane active" id="tab_update_profile" aria-expanded="true" aria-labelledby="base-tab_update_profile">
                                ...
                                <form class="form-horizontal" action="{{ (Setting::get('is_demo_control_enabled') == YES) ? '#' : route('support_member.profile.save') }}" method="POST" enctype="multipart/form-data" role="form">
                                    @csrf

                                    <input type="hidden" name="support_member_id" value="{{Auth::guard('support_member')->user()->id}}">

                                    <div class="form-group">
                                        <label for="name" required class="col-sm-2 control-label">{{ tr('name') }}</label>

                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="name" name="name" value="{{ Auth::guard('support_member')->user()->name }}" placeholder="{{ tr('username') }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="email" required value="{{ Auth::guard('support_member')->user()->email }}" name="email" class="form-control" id="email" placeholder="{{ tr('email') }}" disabled="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" value="{{ Auth::guard('support_member')->user()->about }}" name="about" class="form-control" id=" " placeholder="{{ tr('about') }}">
                            ...
                            <div class="tab-pane" id="tab_upload_image" aria-labelledby="base-tab_upload_image">
                                ...
                                <form class="form-horizontal" action="{{ (Setting::get('is_demo_control_enabled') == YES) ? '#' : route('support_member.profile.save') }}" method="POST" enctype="multipart/form-data" role="form">
                                    ...
                                    @if(Auth::guard('support_member')->user()->picture)
                                        <img style="height: 90px; margin-bottom: 15px; border-radius:2em;" src="{{ Auth::guard('support_member')->user()->picture }}"> 
                                    @else
                            ...
                            <div class="tab-pane" id="tab_change_password" aria-labelledby="base-tab_change_password">
                                ...
                                <form class="form-horizontal" action="{{ (Setting::get('is_demo_control_enabled') == YES) ? '#' : route('support_member.change.password') }}" method="POST" enctype="multipart/form-data" role="form">
                                    @csrf
