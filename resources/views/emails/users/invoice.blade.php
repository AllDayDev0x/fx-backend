                                                            ...
                                                            <tr>
                                                                <td class="attributes_item">
                                                                    <span class="f-fallback">
                                                                        <strong>{{tr('amount')}} :</strong>{{Setting::get('is_only_wallet_payment') ? formatted_amount($data['post_payments']['token'] ?? 0.00) : formatted_amount($data['post_payments']['paid_amount'] ?? 0.00)}}
                                                                    </span>
                                                                </td>
                                                            </tr>
                                                    ...
                                                    <td colspan="2">
                                                        <table class="purchase_content" width="100%" cellpadding="0" cellspacing="0">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="align-right" width="20%" class="purchase_item"><span class="f-fallback">{{Setting::get('is_only_wallet_payment') ? formatted_amount($data['post_payments']['token'] ?? 0.00) : formatted_amount($data['post_payments']['paid_amount'] ?? 0.00)}}</span></td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td width="20%" class="purchase_footer" valign="middle">
                                                                    <p class="f-fallback purchase_total">{{Setting::get('is_only_wallet_payment') ? formatted_amount($data['post_payments']['token'] ?? 0.00) : formatted_amount($data['post_payments']['paid_amount'] ?? 0.00)}}
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                        </table>
