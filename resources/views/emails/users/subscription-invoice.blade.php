                                                            ...
                                                            <tr>
                                                                <td class="attributes_item">
                                                                    <span class="f-fallback">
                                                                        <strong>{{tr('amount')}} :</strong> {{formatted_amount($data['subscription_payments']['amount'] ?? 0.00)}}
                                                                    </span>
                                                                </td>
                                                            </tr>
                                                    ...
                                                    <td colspan="2">
                                                        <table class="purchase_content" width="100%" cellpadding="0" cellspacing="0">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="align-right" width="20%" class="purchase_item"><span class="f-fallback">{{ formatted_amount($data['subscription_payments']['amount'] ?? 0.00)}}</span></td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td width="20%" class="purchase_footer" valign="middle">
                                                                    <p class="f-fallback purchase_total">{{ formatted_amount($data['subscription_payments']['amount'] ?? 0.00)}}</p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
